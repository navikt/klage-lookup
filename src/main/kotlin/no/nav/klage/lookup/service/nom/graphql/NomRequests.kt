...
fun getAnsatteQuery(navIdenter: List<String>): AnsatteGraphqlQuery {
    ...
    return AnsatteGraphqlQuery(query = query, variables = GetAnsatteIdentVariables(navIdenter))
}
...
fun getAnsattQuery(navIdent: String): AnsattGraphqlQuery {
    ...
    return AnsattGraphqlQuery(query = query, variables = IdentVariables(navIdent))
}
